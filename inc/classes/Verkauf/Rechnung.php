...
class Rechnung
{
	...
	public function Create($contact_id, $bill_type){
		...
		if ($bill_type == "exists") {
			...
			$Query = "INSERT INTO JOURNAL (TERM_ID, MA_ID, QUELLE, QUELLE_SUB, ADDR_ID, KUN_NUM, VRENUM, KM_STAND, VERTRETER_ID, GLOBRABATT, RDATUM, PR_EBENE, LIEFART, ZAHLART, MWST_1, MWST_2, MWST_3, WAEHRUNG, GEGENKONTO, SOLL_NTAGE, SOLL_SKONTO, SOLL_STAGE, SOLL_RATINTERVALL, ERSTELLT, ERST_NAME, GEAEND, GEAEND_NAME, KUN_ANREDE, KUN_NAME1, KUN_NAME2, KUN_NAME3, KUN_ABTEILUNG, KUN_STRASSE, KUN_LAND, KUN_PLZ, KUN_ORT, FIRMA_ID, ZAHLART_NAME, ZAHLART_KURZ, ZAHLART_LANG, LIEFART_NAME) VALUES ('$TERM_ID', '$MA_ID', '$QUELLE', '$QUELLE_SUB', '$ADDR_ID', '$KUNNUM', '$VRENUM', -1 , '$VERTRETER_ID', '$GLOBRABATT', '$RDATUM', '$PR_EBENE', '$LIEFART', '$ZAHLART', '$MWST_1', '$MWST_2', '$MWST_3', '$WAEHRUNG', '$GEGENKONTO', '$SOLL_NTAGE', '$SOLL_SKONTO', '$SOLL_STAGE', '$SOLL_RATINTERVALL', '$ERSTELLT', '$ERST_NAME', '$GEAEND', '$GEAEND_NAME', '$KUN_ANREDE', '$KUN_NAME1', '$KUN_NAME2', '$KUN_NAME3', '$KUN_ABTEILUNG', '$KUN_STRASSE', '$KUN_LAND', '$KUN_PLZ', '$KUN_ORT', '$FIRMA_ID', '$ZAHLART_NAME', '$ZAHLART_KURZ', '$ZAHLART_LANG', '$LIEFART_NAME');";

...
class SchrozbergEK
{
	static $serverFiles = array();
	static $remoteFiles = array();
	...
	static public function onlyCSV(array $remoteFiles)
	{
		$files = array();
	...
	static public function remoteFolderContains(string $file){
